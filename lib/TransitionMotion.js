...
var TransitionMotion = _react2['default'].createClass({
  ...
  startAnimationIfNecessary: function startAnimationIfNecessary() {
    ...
    var destStyles = typeof propStyles === 'function' ? propStyles(rehydrateStyles(this.state.mergedPropsStyles, this.unreadPropStyles, this.state.lastIdealStyles)) : propStyles;
    var shouldStop = shouldStopAnimationAll(this.state.currentStyles, destStyles, this.state.currentVelocities, this.state.mergedPropsStyles);

    if (!this.state.started && !shouldStop) {
